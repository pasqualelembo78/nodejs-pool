...
function setNewBlockTemplate(template) {
    ...
    if (cluster.isMaster) {
        ...
        console.log('[*] New ' + coin_str + 'block to mine at ' + template.height + (template.xtm_height ? '/' + template.xtm_height : '') + ' height with ' + template.difficulty + ' difficulty and ' + template.port + ' port (with coin hash factor ' + template.coinHashFactor + ")");
    } else {
