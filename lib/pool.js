...
function submit_block(miner, job, blockTemplate, blockData, resultBuff, isTrustedShare, isParentBlock, isRetrySubmitBlock, submit_blockCB) {
    let reply_fn = function (rpcResult, rpcStatus) {
        ...
        // Success! Submitted a block without an issue.
                          ...
                          ( typeof(rpcResult.result) !== 'undefined' && !(typeof(rpcResult.result) === 'object' && !rpcResult.result.block_id && rpcResult.result.status !== "OK") ) ||
            ...
            const get_block_id = function(cb) {
                ...
                // TARI
                            ...
                            typeof (rpcResult.result) === 'object' && !rpcResult.result.block_id && // no XMR block
            ...
            get_block_id(function(newBlockHash) {
                const is_tari = global.config.daemon.port == blockTemplate.port && typeof (rpcResult.result) === 'object' && !rpcResult.result.block_id;
