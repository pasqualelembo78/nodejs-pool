...
function setNewBlockTemplate(template) {
	...
	const xtm_height = aux_chain_xtm ? aux_chain_xtm.height : '';
        console.log('[*] New ' + coin_str + 'block to mine at ' + template.height + (xtm_height ? '/' + xtm_height : '') + ' height with ' + template.difficulty + ' difficulty and ' + template.port + ' port (with coin hash factor ' + template.coinHashFactor + ")");
    } else {
